 ...
 * Proxies to https://wisdom-walk-app-7of9.onrender.com/api/admin/reports
 */
export async function GET(request: NextRequest) {
  try {
    const qs = request.nextUrl.search // includes leading "?"
    const backendRes = await fetch(`https://wisdom-walk-app-7of9.onrender.com/api/admin/reports${qs}`, {
